...
public class CityAutoCompleteTest extends AbstractTest {

    @Override
    public String getTestName() {
        return "CityAutoCompleteTest";
    }
    ...
    public void test() {
        ...
        driver.findElement(By.xpath("//input[@id='city']")).sendKeys("LA");
        ...
        assertEquals("LA", driver.findElement(By.xpath("//input[@name='city']")).getAttribute("value"));
    }
}
