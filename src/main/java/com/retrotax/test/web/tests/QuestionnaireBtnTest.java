...
public class QuestionnaireBtnTest extends AbstractTest {

    @Override
    public String getTestName() {
        return "QuestionnaireBtnTest";
    }
    ...
    public void test() {
        ...
        assertFalse(driver.findElement(By.xpath("//form/accordion/div/div[1]/div[2]")).isDisplayed());
    }
}
