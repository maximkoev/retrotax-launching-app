...
public class FelonQTest extends AbstractTest {
    ...
    public void test() {
        ...
        driver.findElement(By.xpath("//form/accordion/div/div[2]/div[2]/div/table/tbody/tr[7]/td/div/label[2]")).click();

        assertTrue(driver.findElement(By.xpath("//form/accordion/div/div[5]/div[1]")).isDisplayed());
    }
}
