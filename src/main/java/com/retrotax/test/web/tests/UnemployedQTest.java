...
public class UnemployedQTest extends AbstractTest {

    @Override
    public String getTestName() {
        return "UnemployedQTest";
    }
    ...
    public void test() {
        ...
        driver.findElement(By.xpath("//form/accordion/div/div[2]/div[2]/div/table/tbody/tr[6]/td/div/label[2]")).click();

        assertTrue(driver.findElement(By.xpath("//form/accordion/div/div[7]/div[1]")).isDisplayed());
    }
}
