...
public class RehabilitationQTest extends AbstractTest {

    @Override
    public String getTestName() {
        return "RehabilitationQTest";
    }
    ...
    public void test() {
        ...
        driver.findElement(By.xpath("//form/accordion/div/div[2]/div[2]/div/table/tbody/tr[4]/td/div/label[2]")).click();

        assertTrue(driver.findElement(By.xpath("//form/accordion/div/div[4]/div[1]")).isDisplayed());
    }
}
