 ...
 */
public class TtWPQPresentTest extends AbstractTest {

    @Override
    public String getTestName() {
        return "TtWPQPresentTest";
    }
    ...
    public void test(){
        ...
        Assert.assertEquals("Received vocational rehabilitation services from an Employment Network (Ticket to Work Program)?",
                driver.findElement(By.xpath("//form[@id='frmEmployee']/accordion/div/div[4]/div[2]/div/table/tbody/tr[3]/th")).getText());
